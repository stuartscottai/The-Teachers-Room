...
export const WordWheelGame: React.FC<WordWheelGameProps> = ({ game, options, onBack, onFinish, onReplay }) => {
    ...
    }, [phase, restartWinnerCeremony, clearWinnerCeremonyTimers]);
    ...
    if (phase === 'gameover') {
        ...
        const podiumByRank = new Map<1 | 2 | 3, { index: number; score: number; name: string }>();
        const rankOne = ranking[0];
        const rankTwo = ranking[1];
        const rankThree = ranking[2];
            ...
            >
                ...
                <div className="relative z-10 w-full h-full overflow-y-auto">
                    <div className="max-w-6xl mx-auto px-4 pt-10 sm:pt-14 pb-10 flex flex-col items-center text-center">
                        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-black mb-2">
                            {winnerHeadline}
                        </h1>
                        <p className="text-cyan-100 text-base sm:text-xl mb-6">Final standings</p>
                        ...
                        <div className="relative w-full max-w-6xl mb-8 px-2 sm:px-4">
                            <div className="relative z-20 mx-auto w-fit max-w-full flex items-end justify-center gap-0 sm:gap-1 md:gap-1 pt-14 sm:pt-20 md:pt-24 pb-6 min-h-[300px] sm:min-h-[390px]">
                                ...
                                {ceremonySlots.map((slot, slotIndex) => {
                                    if (!slot) {
                                        return (
                                            <div key={`ceremony-empty-${slotIndex}`} className="w-[124px] sm:w-[168px] md:w-[210px] flex-none" />
                                        );
                                    }
                                    ...
                                    const trophySize = slot.rank === 1
                                        ? (isMobileViewport ? 128 : 146)
                                        : (isMobileViewport ? 94 : 112);
                                    const teamName = slot.team.name || `Team ${slot.team.index + 1}`;
                                    const spotlightColor =
                                        slot.rank === 1
                                            ? 'rgba(255,215,0,0.52)'
                                            : slot.rank === 2
                                              ? 'rgba(192,192,192,0.44)'
                                    ...
                                    return (
                                        <div
                                            key={slot.key}
                                            className="relative flex w-[124px] sm:w-[168px] md:w-[210px] flex-none flex-col items-center"
                                        >
                                            <div
                                                className="absolute left-0 right-0 pointer-events-none z-0"
                                                style={{ height: spotlightHeight, bottom: getPodiumHeight(slot.rank) }}
                                            >
                                            ...
                                            >
                                                ...
                                                >
                                                    <div
                                                        className={`relative wordwheel-winner-float ${slot.rank === 1 ? 'scale-[1.15]' : 'scale-100'}`}
                                                        style={{ animationDelay: `${slotIndex * 180}ms` }}
                                                    >
                                                        <WinnerCeremonyTrophy
                                                            rank={slot.rank}
                                                            size={trophySize}
                                                    ...
                                                    <div className="text-center mt-1">
                                                        ...
                                                        <div
                                                            className="h-1 w-12 mx-auto my-1 rounded-full shadow-[0_0_10px_rgba(34,211,238,0.75)]"
                                                            style={{ backgroundColor: CEREMONY_COLORS.accent }}
                                                        />
                                                ...
                                                <div
                                                    ...
                                                    style={{ height: getPodiumHeight(slot.rank), perspective: '1000px', transformStyle: 'preserve-3d' }}
                                                >
                                                    <div
                                                ...
                                                >
                                                        <span className="text-[3rem] sm:text-[4rem] md:text-[4.5rem] font-black text-black/25 select-none italic leading-none">
                                                            {slot.rank}
                                                        </span>
                                                        <div
                                                            className="absolute top-0 left-0 w-full h-[2px] shadow-[0_0_15px_rgba(34,211,238,0.65)]"
                                                            style={{ backgroundColor: 'rgba(125, 211, 252, 0.65)' }}
                                                        />
                                                        <div
                                                            className="absolute inset-y-0 left-0 w-[14%] pointer-events-none"
                                                            style={{ background: 'linear-gradient(90deg, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0) 100%)' }}
                                                        />
                                                        <div
                                                            className="absolute inset-y-0 right-0 w-[14%] pointer-events-none"
                                                            style={{ background: 'linear-gradient(270deg, rgba(2,6,23,0.16) 0%, rgba(2,6,23,0) 100%)' }}
                                                        />
                                                    </div>
                                                    <div
                                                        className="absolute top-0 left-0 w-full h-6 md:h-7 z-30 rounded-t-xl pointer-events-none"
                                                        style={{
                                                            background: `linear-gradient(180deg, rgba(255,255,255,0.78) 0%, rgba(255,255,255,0.18) 64%, rgba(255,255,255,0) 100%)`,
                                                        }}
                                                    />
                                                    <div
                                                        ...
                                                        style={{
                                                            ...
                                                            boxShadow: '0 4px 8px rgba(15,23,42,0.24), inset 0 1px 2px rgba(255,255,255,0.55)',
                                                        }}
                                                    />
                                                    <div
                                                        className="absolute inset-x-0 bottom-0 h-[22%] pointer-events-none z-30"
                                                        style={{
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8">
                            <button
                                onClick={restartWinnerCeremony}
                                className="px-6 py-3 rounded-xl bg-white/10 border border-white/20 text-white font-bold hover:bg-white/15 transition-all"
                            >
