            ...
            <div ref={scorebarRef} className="bg-white p-2 md:p-4 shrink-0 z-[250] shadow-md border-b border-slate-200 relative min-h-[70px] md:min-h-[140px]">
                <div className="hidden md:flex justify-between items-center gap-4">
                    <div className="flex flex-col items-start gap-2 min-w-[140px]">
                        ...
                        <button
                            ...
                            className="text-white flex items-center text-sm bg-rose-700 hover:bg-rose-600 px-4 py-2 rounded-lg transition-colors font-bold border border-rose-800"
                            title="End game now"
                        >
                ...
                <div className="flex md:hidden items-center gap-3">
                    <div className="flex flex-col items-start gap-2 shrink-0">
                        ...
                        <button
                            onClick={() => setShowEndGameConfirm(true)}
                            className="text-white p-1.5 bg-rose-700 hover:bg-rose-600 rounded-md transition-colors border border-rose-800"
                            title="End game now"
                        >
                            <Flag size={14} />
                        </button>
