...
import { ArrowLeft, Maximize2, Minimize2, AlertTriangle, RotateCcw, X, Check, Trophy, Edit2, Clock, Volume2, VolumeX, CheckCircle, XCircle, RefreshCw } from 'lucide-react';
                            ...
                            <div className={`absolute inset-0 [backface-visibility:hidden] rounded-2xl shadow-2xl overflow-hidden flex flex-col h-full
                                ...
                                {isBonus ? (
                                    ...
                                    <>
                                            ...
                                            <div className="flex flex-col flex-1 min-h-0">
                                                ...
                                                {hasOptions && !isFlipped && (
                                                    <div className="w-full flex-1 min-h-0 mt-1 sm:mt-3 md:mt-6 flex-shrink-0 relative z-10 overflow-y-auto sm:overflow-visible">
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-4 w-full max-w-5xl sm:h-full sm:auto-rows-fr">
                                                            {(() => {
                                        ...
                                        <div className={`h-[clamp(88px,14vh,120px)] flex flex-col px-3 sm:px-4 md:px-8 py-2 md:py-0 relative flex-shrink-0 z-50 transition-colors duration-300 
