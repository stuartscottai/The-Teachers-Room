        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto space-y-8 animate-fade-in">
                    ...
                    <div className="p-8 space-y-6">
                        <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">
                            ...
                            {user.accountType === 'free' && (
                                <p className="text-xs text-slate-500 mt-1">Manual creation is enabled. The Teacher Plan is free during early access if you want AI generation.</p>
                            )}
                        </div>
                        ...
                        <div className="rounded-xl border border-brand-yellow/40 bg-brand-yellow/10 p-4">
                            ...
                            <p className="text-sm text-slate-600 mb-4">
                                Compare Starter, Teacher Plan, and School Plan. The Teacher Plan is free during early access, and no credit card information is required to sign up.
                            </p>
                            <Link
                                to="/change-plan"
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div className="p-8">
                        <p className="text-sm text-slate-600 mb-4">
                            Cancelling your account is permanent and cannot be undone. All saved games and account data will be permanently deleted.
                        </p>
                        <button
                            type="button"
